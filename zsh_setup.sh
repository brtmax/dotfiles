...
install_agnoster_theme() {
  ...
  curl -fsSL https://raw.githubusercontent.com/pixegami/terminal-profile/main/configs/pixegami-agnoster.zsh-theme -o $ZSH_THEMES_DIR/pixegami-agnoster.zsh-theme
